...
const LINKS = [
  ...
  { method: "PUT", url: "https://test-mode.com/api/products/products/:id", badge: "JSON", color: "bg-cyan-500/20 text-cyan-300 border-cyan-500/40" },
  { method: "DELETE", url: "https://test-mode.com/api/products/:id", badge: "204", color: "bg-red-500/20 text-red-300 border-red-500/40" },
];
              ...
              <div className="ml-auto flex items-center gap-1">
                {["json", "curl", "fetch"].map((tab) => (
                  <button
                    ...
                    className={`text-xs px-3 py-1 rounded transition-all ${activeTab === tab
        ...
        <section className="px-6 py-16 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col gap-3">
            {LINKS.map((link) => (
              ...
              >
                <span className={`text-xs font-bold w-14 text-center ${link.method === "GET" ? "text-emerald-400" :
          ...
          <div className="sans text-sm  transition-colors max-w-3xl mt-6 mx-auto text-center">
            Note : This platform provides fake test data for development and testing. All records are automatically refreshed every 5 minutes, so any modifications will be reset. Do not use this data in production.
          </div>
