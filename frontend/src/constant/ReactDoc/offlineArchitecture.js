...
export const createDB = `npm install idb // install this package
...
export const saveOfflinedata =`const saveOffline = async (data) => {
...
export const Exmplecode = `import React from "react";
...
export default function StudentForm() {
   ...
   // Note: Update this URL to match your backend API endpoint (development or production environment).
   // Example: http://localhost:3000/api/save → https://yourdomain.com/api/save
